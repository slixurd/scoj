...
<body>
  ...
  ?>
<center>
  <h3  class="common-header container">
    Contest RankList -- <?php echo $title?>
  </h3>
  <a  class="list-head" href="contestrank.xls.php?cid=<?php echo $cid?>" >Download</a>
</center>

<div class="container-fluid">
  <div class="row-fluid">
    <table id="rank" class="darkshadow" style="margin-top:30px;">
  <thead>
    <tr class="toprow" align="center">
      <td class="{sorter:'false'}">
       Rank<!-- BUG HERE. IF you add a th here,the last colomn of the table will be not included -->
       <th class="span1">User</th>
       <th class="span1">Nick</th>
       <th>Solved</th>
       <th>Penalty</th>
