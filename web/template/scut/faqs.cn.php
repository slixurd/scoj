...
<div class="center well span2 darkshadow" style="margin-left:auto;margin-right:auto;float:none;">
...
<div class="row-fluid">
  <div class="span3">
        ...
        <div class="subnav-faq darkshadow"  >
          <ul class="nav nav-tabs nav-stacked " >
            <li><a href="#complier" class="well">complier</a></li>
            <li><a href="#output" class="well">output</a></li>
            <li><a href="#wrong" class="well">wrong</a></li>
            <li><a href="#return" class="well">return</a></li>
            <li><a href="#attend-contest" class="well">attend-contest</a></li>
            <li><a href="#report-bug" class="well" style="margin-bottom:0;">report-bug</a></li>
          </ul>
        </div>

  </div>
  <div class="span9">
    <div id="complier" class="well darkshadow">
    ...
    <div id="output" class="well darkshadow">
    ...
    <div id="wrong" class="well darkshadow">
    ...
    <div id="return" class="well darkshadow">
    ...
    <div id="attend-contest" class="well darkshadow">
    ...
    <div id="report-bug" class="hero-unit darkshadow">
          <font color=green size="+2">其他问题请访问
