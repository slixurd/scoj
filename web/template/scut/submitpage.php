...
<body>
        ...
        ?>
<div id="main" class="container-fluid buttomspace">
    <div class="row-fluid">
...
<div style="margin-left:5px;margin-top:15px;">
  <h4 class="center " style="padding-bottom:5px;"><?php echo $MSG_Input?></h4>
  <textarea style="margin-right:auto;margin-left:auto;" class="span4 darkshadow" cols=40 rows=5 id="input_text" name="input_text" ><?php echo $view_sample_input?></textarea>
</div>
<div style="margin-left:5px;">
 <h4 class="center" style="padding-bottom:5px;"><?php echo $MSG_Output?></h4>
  <textarea class="span4 darkshadow" cols=40 rows=5 id="out" name="out" >SHOULD BE:
...
<div class="span8" style="margin-left:50px;margin-right:auto;">
<form id="frmSolution" class="span8 textarea"  style="padding-top:35px;"  action="submit.php" method="post"
  <?php if($OJ_LANG=="cn"){?>
   onsubmit="return checksource(document.getElementById('source').value);"
  <?php }?>
 >

  <textarea class="span8 textarea" style="padding-top:25px;" cols=180 rows=20 id="source" name="source"><?php echo $view_src?></textarea>
